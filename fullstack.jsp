...
<head>
    ...
    <script src="<%= request.getContextPath() %>/js/fullstack.js"></script>
</head>
<body data-email="<%= session.getAttribute("email") %>">
    ...
    <div id="instructions-container" class="instructions-container">
       ...
       <ul>
		    ...
		    <li>A minimum passing score of 75% is required to pass the exam.</li>
      </ul>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            // Ensure fullscreen mode in the new window
